...
(read via `search_code`; `get_file_contents` was out of session scope). Council
members independently reached "needs-design-first" from the composition-attack
and category-error directions respectively.
